            ...
            modelBuilder.Entity("hostello.Models.Acomodacao", b =>
                {
                    ...
                    b.Property<int?>("EstabelecimentoIdEstabelecimento")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("EstabelecimentoIdEstabelecimento");
            ...
            modelBuilder.Entity("hostello.Models.Administrador", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nome = "Nicolas",
                            Senha = "$2a$10$MS6IMjI9ULaXvLD1wJoDVepSo6LHEB0/2QsJgtzNt11Z/B4T9ZIRe",
                            Sexo = 1,
            ...
            modelBuilder.Entity("hostello.Models.Responsavel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nome = "Dono Empresa",
                            Senha = "$2a$10$R/31fGV6ld14oxFp79kKZeqBfpS4Ad3iQxD28QjW2Nz81OOXHSIti",
                            Sexo = 2,
            ...
            modelBuilder.Entity("hostello.Models.Acomodacao", b =>
                {
                    b.HasOne("hostello.Models.Estabelecimento", null)
                        ...
                        .HasForeignKey("EstabelecimentoIdEstabelecimento");
